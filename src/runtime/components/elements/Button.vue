...
<template>
  ...
  >
    <slot name="leading" :disabled="disabled" :loading="loading">
      <div v-if="isLeading && leadingIconName" :name="leadingIconName" :class="leadingIconClass" aria-hidden="true" />
    </slot>
    ...
    <slot name="trailing" :disabled="disabled" :loading="loading">
      <div v-if="isTrailing && trailingIconName" :name="trailingIconName" :class="trailingIconClass" aria-hidden="true" />
    </slot>
  </component>
</template>
